...
A free, structured, module-wise Kotlin training program — entry level to master level, with runnable code in every module and a hands-on project at the end of each level.

**Live site:** https://sigilipelli.github.io/kotlin-mastery-path/

## Contents

- **Level 1 · Entry** — language foundations
- **Level 2 · Intermediate** — coroutines, testing, real apps
- **Level 3 · Advanced** — Ktor, databases, multiplatform
