...
first `fun main()` to production-shaped, master-level engineering — with
...
| [Level 2 · Intermediate](level-2/index.md) | Coroutines, testing, real apps | 9 topics + 1 project |
| [Level 3 · Advanced](level-3/index.md) | Ktor, databases, multiplatform | 9 topics + 1 project |
...
- Every topic page has runnable code snippets — copy them into a local `.kt`
  file and run with `kotlinc`/`kotlin`, or paste into your IDE.
